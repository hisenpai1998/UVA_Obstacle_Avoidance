...
DEPTH_RESOLUTION = (256, 256)   # Resolution of the resized depth map
...
OBJECT_PATHS = {
    ...
    'obstacles': ['/Cuboid[0]', '/Cuboid[1]', '/Cuboid[2]', '/Cuboid[3]', '/Cuboid[4]', '/Cuboid[5]']
}

# APF parameters
ATTRACTIVE_GAIN     = 1.0       # Gain for attractive force towards goal
REPULSIVE_GAIN      = 5.0       # Gain for repulsive force from obstacles
